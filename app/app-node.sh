...
app_install_node()
{
    ...
    git clone https://github.com/PhantomCore/phantom-node.git -b explorer "$BRIDGECHAIN_PATH"
    cd "$BRIDGECHAIN_PATH"
    ...
    sed -i -e "s/var db_name = \"phantom_\" + network_name;/var db_name = \"$DATABASE_NAME\";/g" createGenesisBlock.js
